...
namespace Microsoft.Marketplace.SaaS
{
    ...
    /// </summary>
    internal partial class SubscriptionOperations : IServiceOperations<MarketplaceSaaSClient>, ISubscriptionOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal SubscriptionOperations(MarketplaceSaaSClient client)
        {
            if (client == null)
            {
