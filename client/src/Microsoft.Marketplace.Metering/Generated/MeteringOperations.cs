...
namespace Microsoft.Marketplace.Metering
{
    ...
    /// </summary>
    internal partial class MeteringOperations : IServiceOperations<MarketplaceMeteringClient>, IMeteringOperations
    {
        /// <summary>
        /// Initializes a new instance of the MeteringOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal MeteringOperations(MarketplaceMeteringClient client)
        {
            if (client == null)
            {
        ...
        /// <summary>
        /// Gets a reference to the MarketplaceMeteringClient
        /// </summary>
        public MarketplaceMeteringClient Client { get; private set; }
        ...
        public async Task<AzureOperationResponse<UsageEventOkResponse>> PostUsageEventWithHttpMessagesAsync(UsageEvent body, System.Guid? requestId = default(System.Guid?), System.Guid? correlationId = default(System.Guid?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "PostUsageEvent", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "usageEvent").ToString();
            ...
            if ((int)_statusCode != 200 && (int)_statusCode != 400 && (int)_statusCode != 403 && (int)_statusCode != 409)
            {
        ...
        public async Task<AzureOperationResponse<IList<UsageEventOkResponse>>> PostBatchUsageEventWithHttpMessagesAsync(IList<UsageEvent> body, System.Guid? requestId = default(System.Guid?), System.Guid? correlationId = default(System.Guid?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("correlationId", correlationId);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "PostBatchUsageEvent", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "batchUsageEvent").ToString();
            List<string> _queryParameters = new List<string>();
            if (apiVersion != null)
            {
                _queryParameters.Add(string.Format("api-version={0}", System.Uri.EscapeDataString(apiVersion)));
