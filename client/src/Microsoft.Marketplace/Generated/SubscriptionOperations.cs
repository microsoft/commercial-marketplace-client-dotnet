...
namespace Microsoft.Marketplace
{
    ...
    /// </summary>
    internal partial class SubscriptionOperations : IServiceOperations<MarketplaceClient>, ISubscriptionOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal SubscriptionOperations(MarketplaceClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<OperationList>> ListOperationsWithHttpMessagesAsync(System.Guid subscriptionId, System.Guid? requestId = default(System.Guid?), System.Guid? correlationId = default(System.Guid?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "saas/subscriptions/{subscriptionId}/operations").ToString();
        ...
        public async Task<AzureOperationResponse<Operation>> GetOperationStatusWithHttpMessagesAsync(System.Guid subscriptionId, System.Guid operationId, System.Guid? requestId = default(System.Guid?), System.Guid? correlationId = default(System.Guid?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "saas/subscriptions/{subscriptionId}/operations/{operationId}").ToString();
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(Rest.Serialization.SafeJsonConvert.SerializeObject(subscriptionId, Client.SerializationSettings).Trim('"')));
            ...
            // Create Result
            var _result = new AzureOperationResponse<Operation>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> UpdateOperationStatusWithHttpMessagesAsync(System.Guid subscriptionId, System.Guid operationId, System.Guid? requestId = default(System.Guid?), System.Guid? correlationId = default(System.Guid?), string planId = default(string), long? quantity = default(long?), UpdateOperationStatusEnum? status = default(UpdateOperationStatusEnum?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            string apiVersion = "2018-08-31";
            string contentType = "application/json";
            UpdateOperation body = new UpdateOperation();
            if (planId != null || quantity != null || status != null)
            {
                body.PlanId = planId;
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "UpdateOperationStatus", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "saas/subscriptions/{subscriptionId}/operations/{operationId}").ToString();
