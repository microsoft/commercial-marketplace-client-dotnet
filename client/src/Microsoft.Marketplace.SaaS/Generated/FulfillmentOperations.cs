...
namespace Microsoft.Marketplace.SaaS
{
    ...
    /// </summary>
    internal partial class FulfillmentOperations : IServiceOperations<MarketplaceSaaSClient>, IFulfillmentOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal FulfillmentOperations(MarketplaceSaaSClient client)
        {
            if (client == null)
            {
        ...
        /// <summary>
        /// Gets a reference to the MarketplaceSaaSClient
        /// </summary>
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationHeaderResponse<FulfillmentOperationsUpdateSubscriptionHeaders>> UpdateSubscriptionWithHttpMessagesAsync(System.Guid subscriptionId, System.Guid? requestId = default(System.Guid?), System.Guid? correlationId = default(System.Guid?), string planId = default(string), long? quantity = default(long?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            string apiVersion = "2018-08-31";
            ...
            // Create Result
            var _result = new AzureOperationHeaderResponse<FulfillmentOperationsUpdateSubscriptionHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<FulfillmentOperationsUpdateSubscriptionHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationHeaderResponse<FulfillmentOperationsDeleteSubscriptionHeaders>> DeleteSubscriptionWithHttpMessagesAsync(System.Guid subscriptionId, System.Guid? requestId = default(System.Guid?), System.Guid? correlationId = default(System.Guid?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            string apiVersion = "2018-08-31";
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            ...
            // Create Result
            var _result = new AzureOperationHeaderResponse<FulfillmentOperationsDeleteSubscriptionHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<FulfillmentOperationsDeleteSubscriptionHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
